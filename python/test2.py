...
while True:
    ...
    max = 1800
    values0 = adc.read_adc(0, gain=GAIN) * max / 32767
    values1 = adc.read_adc(1, gain=GAIN) * max / 32767
    values2 = adc.read_adc(2, gain=GAIN) * max / 32767
    values3 = adc.read_adc(3, gain=GAIN) * max / 32767
